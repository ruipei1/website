...
```{r include = TRUE,echo = FALSE, message=FALSE, warning = FALSE}
reports = data.frame(name = "[Framing effects on the effectiveness and virality of health messages related to COVID-19](https://cnlab.github.io/covid19-message-framing/) (With the Communication Neuroscience Lab at Upenn)")
